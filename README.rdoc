...
== Using Amazon S3 as your master image store

To use Amazon's S3 service as the store for your master images, you'll need to copy the amazon_s3_sample.yml to your RAILS_ROOT/config directory, rename it to amazon_s3.yml and fill in your connection details.

Then it's as simple as passing an +:s3 => true+ option in your acts_as_fleximage declaration on your model. 
